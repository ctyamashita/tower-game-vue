            ...
            <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                ${availableClasses.map(job=>{
                  return `<div class="swiper-slide" style="background-image: url('images/${job}.png'), radial-gradient(rgba(106, 65, 12, .5) 40%,burlywood 40%); background-size: 90%; background-repeat: no-repeat; background-position: center;">
                            <p>${job}</p>
                          </div>`
                }).join('')}
              </div>

            ...
            <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                ${availableClasses.map(job=>{
                  return `<div class="swiper-slide" style="background-image: url('images/${job}-banner.png'), linear-gradient(-15deg, burlywood 25%, rgba(255,255,255,.5) 70%);">
                            <p>${job}</p>
            ...
            const swiper = new Swiper(".mySwiper", {
              ...
              on: {
                slideChange: (e) => {
                  ...
                  const classTemplate = {...this.classes.find(obj=>obj.job == card.innerText.toLowerCase())}
                  this.player = {
                    lvl: 1,
                    xp: 0,
                    points: 0,

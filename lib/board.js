            ...
            <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                ${availableClasses.map(jobObj=>{
                  return `<div class="swiper-slide" id="${jobObj.job}" style="background-image: url('images/${jobObj.job}-banner.png'), linear-gradient(-15deg, burlywood 25%, rgba(255,255,255,.5) 70%);">
                            <p>${jobObj.job}</p>
                            <img src="images/${jobObj.job}.png" />
                            <p>[${jobObj.actions[1]}]<br><small>${jobObj.skillDescription}</small></p>
                          </div>`
                }).join('')}
              </div>
            </div>

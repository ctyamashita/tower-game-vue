...
createApp({
  ...
  methods: {
    ...
    // combat
    combatTurn(action) {
      if (!this.currentCombat || this.currentCombat.ended || !this.inBattle) this.currentCombat = new Combat(this.player, this.enemy, this.playerOgAttributes);
    ...
    startCombat(coords) {
      ...
      this.playerOgAttributes = {...this.player.attributes}

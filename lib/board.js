      ...
      if (this.movementKeys[keyPressed]) {
        ...
        if (this.isWalkable(newPosition)) {
          ...
          window.requestAnimationFrame(() => {
            ...
            // Hour Hand
            if (this.time.hour )
            drawCircle(centerX, centerY, 20, 0, 360 , false, hourInactiveColor, 'stroke', 8);
            drawCircle(centerX, centerY, 20, 0, rad(15 * (this.time.hour)), false, hourActiveColor, 'stroke', 8);
          });
        }
      }
    },
